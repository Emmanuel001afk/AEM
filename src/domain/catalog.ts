...
export interface StoreApp extends Application { category:string; featured?:boolean; functionality:string[]; screenshots:string[]; permissions:string[]; latest?: Record<ReleaseChannel, Release | undefined>; }
