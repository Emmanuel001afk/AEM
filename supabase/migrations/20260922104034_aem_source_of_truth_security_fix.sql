...
update public.artifacts ar set package_identity=a.package_identity
from public.releases r join public.applications a on a.id=r.application_id
where ar.release_id=r.id and ar.platform='android' and ar.package_identity is null and a.package_identity is not null;

update public.artifacts ar set version_code=r.version_code
