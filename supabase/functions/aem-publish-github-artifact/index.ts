...
const cors={"Access-Control-Allow-Origin":"*","Access-Control-Allow-Headers":"authorization,apikey,content-type,x-github-token,x-aem-repo,x-aem-request-id,x-aem-run-id,x-aem-artifact-name,x-aem-app-name,x-aem-version-name,x-aem-version-code,x-aem-channel,x-aem-package,x-aem-filename,x-aem-title,x-aem-source-release-id"};
...
Deno.serve(async(req)=>{
 ...
 try{
  ...
  let bytes:Uint8Array,repo:string,requestId:string,runId:number,filename:string,appName:string,versionName:string,versionCode:number|null,channel:string,packageIdentity:string,title:string,sourceReleaseId:string;
